...
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors.basePackage("com.zhou.aop.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .title("test")
                // 简介
                .description("This a test for aop")
                // 服务条款
                .termsOfServiceUrl("http://127.0.0.1:8089/v2/api-docs")
                // 作者个人信息
                .contact("zhou.liu")
                // 版本
                .version("1.0").build();
