...
import com.zhou.easyexcel.listener.*;
...
public class ReadTest {
     ...
     *
     * <p>
     * 1. 创建excel对应的实体对象,并使用{@link ExcelProperty}注解. 参照{IndexOrNameData}
     * <p>
    ...
    public void extraRead() {
        String fileName = path + "demo" + File.separator + "extra.xlsx";
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet
    ...
    public void cellDataRead() {
        String fileName = path + "demo" + File.separator + "cellDataDemo.xlsx";
        // 这里 需要指定读用哪个class去读，然后读取第一个sheet
