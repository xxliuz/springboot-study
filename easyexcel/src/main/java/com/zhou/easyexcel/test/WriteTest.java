...
import com.zhou.easyexcel.handler.CustomSheetWriteHandler;
...
public class WriteTest {
    ...
    public void imageWrite() throws Exception {
        ...
        String imagePath = path + "converter" + File.separator + "img.jpg";
...
//                    "https://raw.githubusercontent.com/alibaba/easyexcel/master/src/test/resources/converter/img.jpg"));
    ...
    public void writeCellDataWrite() {
        String fileName = path + "writeCellDataWrite" + System.currentTimeMillis() + ".xlsx";
    ...
    public void annotationStyleWrite() {
        String fileName = path + "annotationStyleWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
    ...
    public void handlerStyleWrite1() {
        ...
        String fileName = path + "handlerStyleWrite" + System.currentTimeMillis() + ".xlsx";
        // 头的策略
    ...
    public void mergeWrite() {
        // 方法1 注解
        String fileName = path + "mergeWrite" + System.currentTimeMillis() + ".xlsx";
        // 在DemoStyleData里面加上ContentLoopMerge注解
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
        EasyExcel.write(fileName, DemoMergeData.class).sheet("模板").doWrite(data());

        // 方法2 自定义合并单元格策略
        fileName = path + "mergeWrite" + System.currentTimeMillis() + ".xlsx";
    ...
    public void tableWrite() {
        String fileName = path + "tableWrite" + System.currentTimeMillis() + ".xlsx";
    ...
    public void longestMatchColumnWidthWrite() {
        String fileName =
                path + "longestMatchColumnWidthWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
    ...
    public void customHandlerWrite() {
        String fileName = path + "customHandlerWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
    ...
    public void commentWrite() {
        String fileName = path + "commentWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
    ...
    public void variableTitleWrite() {
        // 写法1
        String fileName = path + "variableTitleWrite" + System.currentTimeMillis() + ".xlsx";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
