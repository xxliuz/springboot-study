...
public class ExcelUtil {
     ...
     */
    public static <E> List<E> readExcel(InputStream inputStream, Class clazz) throws Exception {
        // 解析每行结果在listener中处理
     ...
     */
    public static void writeExcel(OutputStream outputStream, List<List<String>> dataList, ExcelTypeEnum excelTypeEnum) throws Exception {
        //这里指定不需要表头，因为String通常表头已被包含在data里
        String fileName = "writeExcel" + System.currentTimeMillis() + ".xlsx";
        EasyExcel.write(fileName).excelType(excelTypeEnum).file(outputStream).sheet("模板").doWrite(dataList);
    }
    ...
    public static void writeExcel(OutputStream outputStream, List<? extends DemoData> dataList,
                                  Class<? extends DemoData> clazz, ExcelTypeEnum excelTypeEnum) throws Exception {
        String fileName = "writeExcel" + System.currentTimeMillis() + ".xlsx";
    ...
    public static byte[] writeExcel(ByteArrayOutputStream outputStream,List<String> sheetName,List<List<? extends DemoData>> datas,
                                    List<Class<? extends DemoData>> clazzs, ExcelTypeEnum excelTypeEnum) throws Exception {
